  ...
  return (
    <nav onClick={setOverlay} className="grad absolute overflow-y-scroll z-20 w-60 bg-[#E0E0E0] shadow-xl md:static md:col-span-1 md:h-auto md:w-auto active">
      ...
      <div className={`customProj transition-all -mt-5 opacity-0`}>
        <div className="relative mb-3 pl-7 flex gap-2 mx-auto cursor-pointer flex-wrap items-center hover:font-semibold w-52 lg:w-48 lg:mx-auto lg:gap-4">
          ...
          <svg onClick={(e) => console.log(e.target)}
            xmlns="http://www.w3.org/2000/svg"
            className="absolute right-0 w-5 -sm:w-8 rounded-md cursor-pointer hover:bg-indigo-200"
            fill="none"
            viewBox="0 0 24 24"
            strokeWidth="1.5"
            stroke="currentColor"
        ...
        </div> <div className="relative mb-3 pl-7 flex gap-2 mx-auto cursor-pointer flex-wrap items-center hover:font-semibold w-52 lg:w-48 lg:mx-auto lg:gap-4">
          <div className="w-3 h-3 rounded-full bg-slate-400 lg:translate-x-2"></div>
          <p className="text-md text-slate-900">Custom Project</p>
          {/* max length should be 15 characters  */}
          <svg onClick={(e) => console.log(e.target)}
