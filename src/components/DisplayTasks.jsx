        ...
        <button tabIndex="-1" className="flex w-full cursor-default flex-row items-center justify-between sm:gap-1  sm:px-3 py-1">
          ...
          <div className={`relative ${locationName === "Completed-tasks" ? ["pointer-events-none", "text-zinc-400"].join(" ") : ""}`}>
            ...
            <span
              style={{ opacity: "0" }}
              data-span-priorty
              className="hidden z-20 absolute top-0 -mt-2 -ml-20 flex h-fit w-24 -translate-x-8 -translate-y-3 flex-col gap-1 rounded-lg bg-[#3772FF] py-1 px-2 text-left text-base font-medium tracking-normal text-[#FFFFFF]  transition-all duration-150 ease-in-out after:absolute after:-right-11 after:bottom-2/3 after:h-0 after:w-0 after:-translate-x-5 after:translate-y-4 after:-rotate-90 after:border-[15px] after:border-transparent after:border-t-[#3772FF] after:content-['']"
            >
